	...
	groups := []struct {
		...
		},
		{
			...
			Commands: []string{
				...
				"jules task        Show or create a Jules task",
				"jules tasks       List all Jules tasks",
				"jules cancel      Cancel a running Jules task",
				"jules history     Show completed Jules tasks",
				"jules logs        Show Jules task logs",
				"jules config      Show or set Jules configuration",
			},
		},
		{
			Title: "Utilities",
